...
func check(conn net.Conn, selectedArray [][]byte, digit byte, firstCountResult[]int) [][]byte {
	...
	for h:=0; h<100; h++{  
		...
		//	digitCount2 := []byte{}
			...
			// 		fmt.Println(i+1,"桁目",digitCount)
					
			// 	}

			// 	fmt.Println(selectedArray)

			// 	for _,g := range selectedArray{
			// 		correctCount := 0
			// 		for h:=0; h<int(digit); h++{
			// 			if slices.Contains(g,digitCount[h]){
			// 				correctCount++
			// 			}
			// 		}
			// 		for {
			...
			// 				tmp8 = append(tmp8, g)
			// 				fmt.Println("1個しかあってない")
			// 			}
			// 		}
			// 		selectedArray4 = append(selectedArray4,tmp0...)
			// 		selectedArray4 = append(selectedArray4,tmp1...)
			// 		selectedArray4 = append(selectedArray4,tmp2...)
			// 		selectedArray4 = append(selectedArray4,tmp3...)
			// 		selectedArray4 = append(selectedArray4,tmp4...)
			// 		selectedArray4 = append(selectedArray4,tmp5...)
			// 		selectedArray4 = append(selectedArray4,tmp6...)
			// 		selectedArray4 = append(selectedArray4,tmp7...)
			// 		selectedArray4 = append(selectedArray4,tmp8...)
			// 	}

			// 	fmt.Println(selectedArray4[0],"maksfdja")
			// 	fmt.Println(selectedDigit,"final")
			// 	digitCount = []byte{}
			// }	
